 ...
 *
 * @property int $id
 * @property \App\Models\User|null $phone
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property int $user_id
...
namespace App\Models{
/**
 * App\Models\ReturnSetting
 *
 * @property int $id
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|ReturnSetting newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|ReturnSetting newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|ReturnSetting query()
 */
	class ReturnSetting extends \Eloquent {}
}
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|Role[] $users
...
namespace App\Models{
/**
 * App\Models\SubReason
 *
 * @property int $id
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|SubReason newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|SubReason newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|SubReason query()
 */
	class SubReason extends \Eloquent {}
}
